 ...
 */
package com.lhfeiyu.dao.base;

import java.util.List;
import java.util.Map;

import com.lhfeiyu.po.base.BaseAaTemplate;
import com.lhfeiyu.po.base.BaseAaTemplateMain;

public interface BaseAA_UtilMapper {
    ...
    /** 查询数据，返回模板基本型对象  */
    BaseAaTemplate selectForTemplateBase(Map<String,Object> map);
    
    /** 查询数据，返回模板详细型对象  */
    BaseAaTemplateMain selectForTemplateMain(Map<String,Object> map);
    
    /** 查询数据，返回模板基本型对象集合  */
    List<BaseAaTemplate> selectForTemplateBaseList(Map<String,Object> map);
    
    /** 查询数据，返回模板详细型对象集合  */
    List<BaseAaTemplateMain> selectForTemplateMainList(Map<String,Object> map);
