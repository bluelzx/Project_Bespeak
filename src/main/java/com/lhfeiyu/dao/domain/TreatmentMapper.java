...
/**
* <strong> 描&nbsp;&nbsp;&nbsp;&nbsp;述：</strong> 持久层Mapper：Treatment <p>
...
public interface TreatmentMapper extends CommonMapper<Treatment> {
	List<Treatment> selectListByShopId(Map<String, Object> map);
}