...
/**
 * <strong> 描&nbsp;&nbsp;&nbsp;&nbsp;述：</strong> 基础库-业务层：推送 <p>
 ...
 * <strong> 备&nbsp;&nbsp;&nbsp;&nbsp;注：</strong>  <p>
 */
@Service("basePushService")
public class BasePushService {
	
	public static String doPush(String pushUrl, String param, String authorization){
		System.out.println("PushService-doPush-pushUrl: "+pushUrl);
		System.out.println("PushService-doPush-authorization:"+authorization);
		System.out.println("PushService-doPush-param:"+param);
