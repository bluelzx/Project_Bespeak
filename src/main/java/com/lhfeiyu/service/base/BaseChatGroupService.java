...
/**
 * <strong> 描&nbsp;&nbsp;&nbsp;&nbsp;述：</strong> 业务层：推送 <p>
 * <strong> 作&nbsp;&nbsp;&nbsp;&nbsp;者：</strong> 虞荣华 <p>
 * <strong> 编写时间：</strong> 2015-7-4 10:08:21 <p>
 * <strong> 公&nbsp;&nbsp;&nbsp;&nbsp;司：</strong> 成都蓝海飞鱼科技有限公司 <p>
 * <strong> 版&nbsp;&nbsp;&nbsp;&nbsp;本：</strong> 1.0 <p>
 */
@Service("baseChatGroupService")
public class BaseChatGroupService {
...
/*	@Autowired
    ...
    public static String createGroup(ChatGroup group){
		...
		String subSig = LhConst.generateSubSig(subAccount, password, timeStamp);
		String url = LhConst.rl_ytx_base_sub_url+subAccount+"/Group/CreateGroup?sig="+subSig;
		String authorization = LhConst.getSubAuthorization(subAccount, timeStamp);
		...
		String r = BasePushService.sendPost(url, param, authorization);
    ...
    public static boolean deleteGroup(ChatGroup group){
    	...
    	String timeStamp = new SimpleDateFormat("yyyyMMddHHmmss").format(new Date());
		String subSig = LhConst.generateSubSig(subAccount, password, timeStamp);
		String url = LhConst.rl_ytx_base_sub_url+subAccount+"/Group/DeleteGroup?sig="+subSig;
		String authorization = LhConst.getSubAuthorization(subAccount, timeStamp);
    ...
    public static void main(String[] args) {
    	...
    	for(int i = 121;i<=129;i++){
			...
			group.setGroupName("即时拍"+i);
			group.setPermission("0");
			group.setType("2");
			group.setThirdName(LhConst.rl_ytx_default_subAccount);//换为应用登陆
			group.setThirdPassword(LhConst.rl_ytx_default_password);
			String groupId = BaseChatGroupService.createGroup(group);
