...
$(function(){
	...
	addAnnouncementForm();
	// 跳转页面的readonly只读设置
	//注意：需要放到js里等待easyui的js加载完毕
	readonly();
});

function readonly(){
	$('#f_title').textbox('readonly',true);
	$('#f_mainStatus').combobox('readonly',true);
	$('#f_author').combobox('readonly',true);
	$('#f_content').textbox('readonly',true);
	$('#f_description').textbox('readonly',true);
	$('#f_orgin').textbox('readonly',true);
	$('#f_userId').combobox('readonly',true);
	$('#f_content').textbox('readonly',true);
	$('#f_keywords').textbox('readonly',true);
	$('#f_tags').textbox('readonly',true);
	$('#f_isHot').combobox('readonly',true);
	$('#f_isRecommend').combobox('readonly',true);
	$('#f_isShowIndex').combobox('readonly',true);
	$('#f_isGood').combobox('readonly',true);
	$('#f_isTop').combobox('readonly',true);
	$('#f_roleId').combobox('readonly',true);
	$('#f_catId').combobox('readonly',true);
	$('#f_organization').textbox('readonly',true);
	$('#f_startDate').datetimebox('readonly',true);
	$('#f_endDate').datetimebox('readonly',true);	
}
