...
//	        	else if(value == 'shipping_status_return'){status = '<span style="color:blue">退回服务</span>';}
	        ...
	        {field:'shippingStatusCode',title:'服务进度情况code',width:150,align:'center',formatter: function(value,row,index){
	        	...
	        	else if(value == 'shipping_status_return'){status = '<span style="color:orange">服务被取消</span>';}
	        	return status;
	        }},
	        {field:'payStatusCode',title:'支付状态code',width:150,align:'center',formatter: function(value,row,index){
	        	var status = "未付款";
	        	if(value == 'pay_status_todo'){status = '<span>未付款</span>';}
	        	else if(value == 'pay_status_done'){status = '<span style="color:orange">已付款</span>';}
	        	return status;
	        }},
	        {field:'orderDoneStausCode',title:'总订单状态code',width:150,align:'center',formatter: function(value,row,index){
	        	var status = "未完成";
	        	if(value == 'order_done_status_no'){status = '<span>未完成</span>';}
	        	else if(value == 'order_done_status_yes'){status = '<span style="color:orange">已完成</span>';}
	        	return status;
	        }},
