...
function getMainDataList(statusFlag){
    var rsp = {
        ...
        rows :
        [
            {id:'1',detailsName:'小儿推拿',providerOldTitle:'32岁-高级技师',orderStateClass:'ordering',orderState:'进行中',time:'2016.06.29',orderHref:'#',btnState:'queren',operation:'确认完成',StateNG:'quxiao',operationNG:'取消订单'},
            {id:'2',detailsName:'足疗',providerOldTitle:'28岁-高级技师',orderStateClass:'order-pj',orderState:'待评价',time:'2016.05.29',orderHref:'#',btnState:'pingjia',operation:'评价'},
