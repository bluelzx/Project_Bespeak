...
<link rel="stylesheet" type="text/css" href="/css/front/self.css" title="v" />
	...
	<%@ include file="/views/front/common/z_div_top_nav.htm"%><!-- 顶部导航 -->
	 <div class="weui_cells weui_cells_form" style="margin-top:50px;min-height:500px;">
         ...
         <div >
         	...
         	<div class="weui_cell" id="end" style="">
	            <div class="weui_cell_hd"><label class="ipt_label">截止日期</label></div>
	            <div class="weui_cell_bd weui_cell_primary">
         ...
         <%-- 	<div class="weui_cell" id="auctionQuickType">
            ...
            <div class="weui_cell" id="bailValue">
	            <div class="weui_cell_hd"><label class="ipt_label">起拍价</label></div>
	            <div class="weui_cell_bd weui_cell_primary">
	                <input class="weui_input" type="text" id="priceBegin" placeholder="请填写起拍价">
	            </div>
	        </div>
	        <div class="weui_cell" id="bailValue">
	        <div class="weui_cell_hd"><label class="ipt_label">加价幅度</label></div>
	            <div class="weui_cell_bd weui_cell_primary">
	                <input class="weui_input" type="text" id="increaseRangePrice" placeholder="请填写加价幅度">
	            </div>
	        </div>
	         <div class="weui_cell" id="bailValue">
	            <div class="weui_cell_hd"><label class="ipt_label">一口价</label></div>
	            <div class="weui_cell_bd weui_cell_primary">
	                <input class="weui_input" type="text" id="buyoutPrice" placeholder="请填写一口价">
	            </div>
	        </div>
         	<div class="weui_cell" id="bailValue">
	            <div class="weui_cell_hd"><label class="ipt_label">保证金</label></div>
	            <div class="weui_cell_bd weui_cell_primary">
	     ...
	     <div class="weui_cell weui_cell_switch" onclick="isSevenReturnCheck()">
            ...
            <div class="weui_cell weui_cell_switch">
                <div class="weui_cell_hd weui_cell_primary">包邮</div>
                <div class="weui_cell_ft">
                    <input class="weui_switch" type="checkbox" checked="checked" id="postageFee">
                </div>
            </div>
 	...
 	<button id="auctionMicroBtn" class="btn weui_btn_primary pointer release_btn frontHide" onclick="addAuctionMicro();">发布</button>
	<button id="auctionTypeBtn" class="btn weui_btn_primary pointer release_btn frontHide" onclick="auction('','first');return false;">选择拍卖类型</button>  
        ...
        <div class="weui_actionsheet" id="weui_actionsheet1">
            <div class="weui_actionsheet_menu">
            	<c:if test="${!empty auctionInst.id}">
                	<div class="weui_actionsheet_cell pointer" onclick="chooseAuctionType(1,'')">专场</div>
                </c:if>
                <c:if test="${empty auctionInst.id}">
                	<div class="weui_actionsheet_cell pointer" onclick="javascript:location.href='/instApply'">申请开通专场</div>
                </c:if>
                 <div class="weui_actionsheet_cell pointer" onclick="chooseAuctionType(3,'')">微拍</div>
                 
              <%-- //DOTO tempHide  <c:if test="${!empty auctionQuickInst.id}">
                	<div class="weui_actionsheet_cell pointer" onclick="chooseAuctionType(2,'')">即时拍</div>
                </c:if>
