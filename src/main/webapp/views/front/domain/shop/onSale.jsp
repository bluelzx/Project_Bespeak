...
<body style="background-color: #f5f5f5;">
				...
				<div class="hd">
					<ul>
						<c:if test="${empty wholesale}">
							...
							<li class="on pointer" onclick="location.href='/sale/${userId}'">在售</li>
						...
						<c:if test="${!empty wholesale}">
							...
							<li class="on pointer" style="width:25%" onclick="location.href='/sale/${userId}'">在售</li>
					...
					<div class="t_0100_11">
						<div class="slide_cp" >
							<div class="obd" style="margin-top:10px;" >
								<ul class="ul_gg" style="width:100%" id="onSale">
								</ul>
							</div>
						</div>
					</div>
					...
					<div class="mainsmall" id="auctionOnlineMain">
						<div id="main" role="main" style="border-bottom: 1px solid #CDCDCD; background: white;">
							<div style="padding: 0 5px;">
								<ul id="onSale" class="mainul mainul1" style="width:100%">
	...
	<script type="text/javascript" src="/js/front/shop/onSale.js" title="v"></script>
	...
	<script id="template" type="x-tmpl-mustache">
		{{#rows}}
			<li style="width:45%;float:left;margin: 5px;" 
				{{#promoteUserSerial}}
					onclick="location.href='/goods/{{id}}?shopId={{shopId}}&promoteUserSerial={{promoteUserSerial}}'" 
				{{/promoteUserSerial}}
				{{^promoteUserSerial}}
					onclick="location.href='/goods/{{id}}?shopId={{shopId}}'" 
				{{/promoteUserSerial}}
