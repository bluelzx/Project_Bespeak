...
<body style="background-color: #f5f5f5;">
			...
			<div class="slide_shop" id="slide_shop">
				<div class="extension">
					<div style="text-align: center;padding-top: 5px;padding-left:0px;padding-right:0px;">
						...
						<a href="javascript:;" class="weui_btn weui_btn_primary"  onclick="$('.navcdbox').show();" >藏品分类：拍卖中 ∨</a><!-- width:48% -->
					</div>
				</div>
				<div class="pz_main">
	...
	<script type="text/javascript" src="/js/front/shop/gm/auctionning.js" title="v"></script>
		...
		{{#rows}}
			<li style="width:45%;float:left;margin: 5px;"  class="mainulli goods_bg">
				...
				{{^shopPrice}}
					<h3>议价</h3>
				{{/shopPrice}}
				<h2 id="auctioning" style="color:rgb(91, 192, 222);" >正在拍卖中....</h2>
