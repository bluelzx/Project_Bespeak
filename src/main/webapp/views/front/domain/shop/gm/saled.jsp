...
<body style="background-color: #f5f5f5;">
			...
			<div class="slide_shop" id="slide_shop">
				<div class="extension">
					<div style="text-align: center;padding-top: 5px;padding-left:0px;padding-right:0px;">
						...
						<a href="javascript:;" class="weui_btn weui_btn_primary"  onclick="$('.navcdbox').show();" >藏品分类：已售 ∨</a><!-- width:48% -->
					</div>
				</div>
				<div class="pz_main">
	            ...
	            <div class="menu-listbox">
	                <div id="firstpane" class="menu_list fr">
	                    ...
	                    <c:if test="${moduleId == 5}">
	                    	<p class="menu_head dbbstype" onclick="location.href='/gm/frozen/${moduleId}'">商品来源</p>
	                    </c:if>
	...
	<script type="text/javascript" src="/js/front/shop/gm/saled.js" title="v"></script>
