...
<%@ include file="/views/front/common/z_div_top_nav.htm"%><!-- 顶部导航 -->
	...
	<script src="/js/front/user/returnGoods.js" title="v"></script>
	<script id="template" type="x-tmpl-mustache">
		{{#rows}}
			...
			<div style="clear:both;"><br/></div>
				{{#isSeller}}
					<button class="btn weui_btn_primary fr pointer" style="color: #FFFFFF;" onclick="agree({{id}});return false;">同意</button>
					<button class="btn weui_btn_warn fl pointer" style="color: #FFFFFF;" onclick="disagree({{id}});return false;">拒绝</button>
				{{/isSeller}}
				{{^isSeller}}
					<button class="btn weui_btn_primary fr pointer" style="color: #FFFFFF;" onclick="cancel({{id}});return false;">取消</button>
				{{/isSeller}}
			</div>
		{{/rows}}		 
	</script>
