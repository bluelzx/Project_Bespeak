...
<%@ include file="/views/front/common/z_div_top_nav.htm"%><!-- 顶部导航 -->
 	<div class="pz_main" style="margin-top:50px;">
 		<input type="hidden" value="${user.id}" id="id">
	 		<ul class="information">
				<li>
					<input type="text" style="width:90%;font-size: 16px;" id="phone" value="${user.phone}" placeholder="请输入要发送验证码的手机号码" />
				</li>
				...
				<li>
					<input type="text" style="width:90%;font-size: 16px;" id="verifyCodeNum" placeholder="请把手机接收到的验证码填到此处"/>
				</li>
				<li id="newPass" style="display:none;">
					<input type="password" style="width:90%;font-size: 16px;" id="newPassWord" placeholder="请输入新的密码"/>
				</li>
			</ul>
	...
	<script src="/js/front/user/loginPasswordFind.js" title="v"></script>
</body>
</html>
