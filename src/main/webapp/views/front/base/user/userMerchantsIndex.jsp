		...
		<div class="row customerIndexHead">
			<div class="col-xs-12 pl7 pr0 bdb-white pb10">
				...
				<div class="col-xs-9 pt20 mt-10">
					<div class="col-xs-12 plr0 text-right" onclick="lh.jumpR('/user');">切换到买家</div>
		...
		<div class="row customerIndexMenu">
			<a href="">
				<div class="col-xs-3 list">
					<img src="/images/front/customer_menu_01.png" height="25" class="img-responsive center-block pb15"> 订单管理
				</div>
			</a> <a href="">
				<div class="col-xs-3 list">
					<img src="/images/front/customer_menu_02.png" height="25" class="img-responsive center-block pb15"> 宝贝管理<i class="red icon-circle"></i>
				</div>
				...
				<div class="col-xs-3 list"  >
					<img src="/images/front/customer_menu_06.png" height="25" class="img-responsive center-block pb15"> 群发信息<i class="red icon-circle"></i>
				</div>
			</a> <a href="">
				<div class="col-xs-3 list">
					<img src="/images/front/customer_menu_07.png" height="25" class="img-responsive center-block pb15"> 消息通知
				</div>
			</a> <a href="/forumIndex">
				<div class="col-xs-3 list" >
				...
				<div class="col-xs-3 list" >
					<img  src="/images/front/customer_menu_08.png" height="25" class="img-responsive center-block pb15"> 微拍管理
				</div>
			</a> 
			</a> <a href="">
				<div class="col-xs-3 list" >
					<img  src="/images/front/customer_menu_08.png" height="25" class="img-responsive center-block pb15"> 专场管理
				</div>
			</a> 
			</a> <a href="">
				<div class="col-xs-3 list" >
					<img  src="/images/front/customer_menu_08.png" height="25" class="img-responsive center-block pb15"> 微拍社区
				</div>
			</a> 
		</div>
	</div>
...
<script type="text/javascript">
	localStorage.setItem("url","/userMerchantsIndex");
</script>
</body>
</html>