...
<%@ include file="/views/front/common/z_div_top_nav.htm"%><!-- 顶部导航 -->
	...
	<script src="/js/front/user/shipping.js" title="v"></script>
		...
		{{#rows}}
			...
			<div style="clear:both;"><br/></div>
				<div class="pointer fr">
					<nobr>
						<button type="button" onclick="lh.jumpR('/courierNum/{{id}}/{{orderId}}');" class="weui_btn weui_btn_primary" style="position: relative; z-index: 1;font-size:16px;">发货</button>
					</nobr>
				</div>
			</div>
		{{/rows}}		 
