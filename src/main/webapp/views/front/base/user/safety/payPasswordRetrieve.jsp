...
<body style="background-color: #f0f0f6;">
        ...
        <div class="row white_bg mt6">
        	...
        	<div class="col-xs-10 plr0 ptb10">
                <div class="col-xs-12 pl0">
            		<input type="tel" disabled="true"  style="font-size: 20px;" class="form-control bdn" id="phone" value="${userPhone}" />
                </div>
        	</div>
        </div>
        <div class="row white_bg mt6">
        	...
        	<div class="col-xs-6 plr0 ptb10">
                <div class="col-xs-12 pl0">
            		<input type="number" id="usererifyCodeNum" class="form-control bdn" placeholder="请输入验证码" >
                </div>
        	</div>
            <div class="col-xs-4 pl0 text-right pt10" onclick="sendVerify();">
                <a rel="button" id="btnMssage" class="btn btn-orange">获取验证码</a>
            </div>
        </div>
        <div class="row white_bg mt6">
            <div class="col-xs-2 pr0 pb10 pt15">
            ...
            <div class="col-xs-10 plr0 ptb10">
                <div class="col-xs-12 pl0">
                    <input type="password" id="newPayPassword" class="form-control bdn" placeholder="请输入新的支付密码" >
                </div>
            </div>
        </div>
        <div class="row pt30">
            <div class="col-xs-12 pt30" onclick="updatePayPassword(${user.id});">
                <a rel="button" class="col-xs-12 btn btn-lg btn-orange">完成</a>
            </div>
        </div>
    </div>
	...
	<script type="text/javascript" src="/js/front/wpk/my.js" title="v"></script>
    	<script type="text/javascript" src="/js/front/user/safety/payPasswordRetrieve.js" title="v"></script>
</body>
</html>