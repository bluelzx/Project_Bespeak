        ...
        <div class="row white_bg mt6">
        	...
        	<div class="col-xs-10 plr0 ptb10">
                <div class="col-xs-12 pl0">
            		<input type="tel" class="form-control bdn" placeholder="请输入手机号" >
                </div>
        	</div>
        </div>
        <div class="row white_bg mt6">
        	...
        	<div class="col-xs-6 plr0 ptb10">
                <div class="col-xs-12 pl0">
            		<input type="number" class="form-control bdn" placeholder="请输入验证码" >
                </div>
        	</div>
            <div class="col-xs-4 pl0 text-right pt10">
                <a href="" rel="button" class="btn btn-orange">获取验证码</a>
            </div>
        </div>
        <div class="row white_bg mt6">
            <div class="col-xs-2 pr0 pb10 pt15">
            ...
            <div class="col-xs-10 plr0 ptb10">
                <div class="col-xs-12 pl0">
                    <input type="password" class="form-control bdn" placeholder="请输入新的密码" >
                </div>
            </div>
        </div>
        <div class="row pt30">
            <div class="col-xs-12 pt30">
                <a href="" rel="button" class="col-xs-12 btn btn-lg btn-orange">完成</a>
            </div>
        </div>
    </div>
