...
<body style="background-color: #f0f0f6;">
    <div class="container-fluid">
        ...
        <div class="row white_bg mt6">
        	...
        	<div class="col-xs-8 plr0 ptb10">
                <div class="col-xs-12 pl0 bdr">
            		<input type="password" class="form-control bdn" placeholder="请输入支付密码" >
                </div>
        	</div>
            <div class="col-xs-2 plr0 pt20" id="passwordeyes">
                <img width="25" src="/images/front/eyes.png" class="center-block">
            </div>
        </div>
        <div class="row pt30">
            <div class="col-xs-12 pt30" onclick="passwordSet(${user.id});">
	...
	<script type="text/javascript" src="/js/front/user/safety/paypasswordSet.js" title="v"></script>
