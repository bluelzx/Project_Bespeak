...
<input type="hidden" value="${noPhone}" id="noPhone">
 	...
 	<div class="pz_main">
		<div class="c_0100_21">
		    <div class="t_0100_19">
	            ...
	            <div class="r_59"><a href="/credit/${user.id}">个人<br />荣誉</a></div>
		    </div>
	        <div class="t_0100_20">
	            <div class="li_my pointer" onclick="location.href='/notice'">
	                <div id="noticeCt_userCtr" class="t_my">0</div>
	                <div class="d_my">消息</div>
	            </div>
	            <div class="li_my pointer" onclick="location.href='/fans'">
	        ...
	        <div class="t_0100_21">
	            <div class="title_4">
	                ...
	                <div class="more_4"><a href="/cart">查看全部商品&nbsp;<img src="/images/front/my_img3.png" width="12" height="20" /></a></div>
	            </div>
	            <div class="tt_0100_7">
	                <div class="li_order" onclick="location.href='/buyerBid'">
	                	<div class="img_order">
	                    	<div class="a_or">
	                ...
	                <div class="li_order" onclick="location.href='/waitPayMoney'">
	                	<div class="img_order">
	                ...
	                <div class="li_order" onclick="location.href='/shipping'">
	                	<div class="img_order">
	                ...
	                <div class="li_order" onclick="location.href='/shipped'">
	                	<div class="img_order">
	                ...
	                <div class="li_order" onclick="location.href='/commenting'">
	                	<div class="img_order">
	        ...
	        <div class="t_0100_22">
	        	<div class="slide_shop" id="slide_shop">
		    	    <div class="hd">
		    	        <ul>
		    	            <li class="pointer" onclick="javascript:location.href='/user'">财务管理</li>
		                    <li class="pointer" onclick="javascript:location.href='/myTrade'">我的交易</li>
		                    <li class="on pointer" onclick="javascript:location.href='/userInfo'">个人信息</li>
			            </ul>
		    	    </div>
		            <div class="bd">
		            	<div class="shop_show">
		                	<div class="t_0100_23 botwoline">
		                	    <a href="javascript:lh.jumpR('/accountInformation');" class="a_finance">
		                        	<span class="span_7">账户信息</span>
		                        </a>
		                	</div>
		                    <div class="t_0100_23 botwoline">
		                	    <a href="javascript:lh.jumpR('/realName');" class="a_finance">
		                        	实名认证
		                        </a>
		                	</div>
		                    <div class="t_0100_23 botwoline">
		                	    <a href="javascript:lh.jumpR('/address');" class="a_finance">
		                        	设置收货地址
		                        </a>
		                	</div>
		                    <div class="t_0100_23 botwoline">
		                	    <a href="javascript:lh.jumpR('/loginPassFind');" class="a_finance">
		                        	找回登录密码
		                        </a>
		                	</div>
		                    <div class="t_0100_23 botwoline">
		                	    <a href="javascript:lh.jumpR('/loginPassSet');" class="a_finance">
		                        	修改登录密码
		                        </a>
		                	</div>
	...
	<script src="/js/front/user/personInformation.js" title="v"></script>
</body>
</html>
