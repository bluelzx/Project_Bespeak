...
<%-- <input type="hidden" id="currentUserId" value="${currentUserId}"> --%>
	...
	<div class="c_0100_19">
			 <div class="slide_sale slide_teacher c_0100_3" style="padding:0;text-align: center;" id="slide_sale">
				<div class="cytopdiv">
					<span class="cytopdiv1 pointer" style="color:white;" onclick="lh.jumpR('/cart');">已买商品</span>
					<span class="cytopdiv2 pointer" onclick="lh.jumpR('/purchased');">已卖商品</span>
				</div>
			</div>
		</div>
		<div class="c_0100_14">
	...
	<script type="text/javascript" src="/js/front/cart/cart.js" title="v"></script>
	<script id="template" type="x-tmpl-mustache">
	{{#rows}}
		<div goodsId="{{goodsId}}" class="teacher_list pointer">
				<div shopId="{{shopId}}" style="width:40px;height:40px;overflow:hidden;float:left" onclick="javascript:location.href='{{&shopUrl}}'">
					<img src="{{picPath}}" width="100%" />
				</div>
				<div class="r_595 pointer" style="width:85%"  onclick="javascript:location.href='{{&shopUrl}}'">
