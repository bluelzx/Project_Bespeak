...
<input type="hidden" id="forumId" value="${forum.id}"/>
	...
	<div class="container-fluid">
		...
		<div class="row auction_title">
			...
			<div class="col-xs-7 pt10 plr0 text-center">
				<span class="fs16">公告</span>
			</div>
		</div>
		<div id="data-container">
		</div>
			<br/>
	<div style="magin-top:20px" class="myCircleIndex" id="announcementController" onclick="lh.jumpR('/addAnnouncement/${forum.id}')">
		    发布公告
	</div>
	...
	<!-- <script type="text/javascript">lh.param = ${paramJson}</script> -->
	<script src="/js/front/announcement/announcement.js" title="v"></script>
	...
	{{#rows}}
		<div class="row white_bg myTeam mt6">
			<div class="col-xs-12 ptb5" style="padding-top: 10px;padding-bottom: 5px;">
				<div class="col-xs-10 plr0" onclick="lh.jumpR('/announcementInfo/{{id}}');">
					<font size="5px" > 【公告】{{title}}</font>
				</div>
                {{&delete_an}}
