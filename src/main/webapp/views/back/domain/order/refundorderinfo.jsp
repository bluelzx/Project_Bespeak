...
<body>
	...
	<table id="mainQueryTable">
		<tbody>
			...
			<!-- <td class="td_pad"><span>订单用户：</span><input id="sc_userId" role="combobox" class="domain-input easyui-combobox width140" /></td> -->
			 ...
			 <td class="td_pad"><span>订单状态：</span><input id="sc_orderStatusCode" role="combobox" class="domain-input easyui-combobox width140"  data-options="readonly:true,editable:false,disabled:true"/></td>
	...
	<div id="mainObjWindiv" style="display: none;">
		<div id='mainObjWin' class="easyui-window" title="订单退款信息管理" style="width: 730px;" data-options="modal:true,closed:true,maximizable:false,collapsible:false,minimizable:false">
			<div id="mainObjTip"></div>
			<form id="mainObjForm">
				<table id="mainObjTable" class="padL5">
					<tbody>
					    <tr class="tr_ht" align="left">
							<td colspan="3" class="td_pad" style="height:20px;width:600px;font-size: 15px;"><span>退款信息不可修改：</span></td>
						</tr>
						<tr class="tr_ht" align="right">
                            ...
                            <td class="td_pad"><span>门店：</span><input id="f_shopId" data-options="required:true" role="combobox" class="domain-input easyui-combobox width140" data-options="readonly:true,editable:false,disabled:true"/></td>
                            <td class="td_pad"><span>服务：</span><input id="f_goodsId"  data-options="required:true" role="combobox" class="domain-input easyui-combobox width140" data-options="readonly:true,editable:false,disabled:true"/></td>
						</tr>
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span>服务技师：</span><input id="f_providerId" role="combobox" class="domain-input easyui-combobox width140" data-options="readonly:true,editable:false,disabled:true"/></td>
							<td class="td_pad"><span>客户邮箱：</span><input id="f_email" role="textbox" class="domain-input easyui-textbox width140" data-options="readonly:true,editable:false,disabled:true"/></td>
							<td class="td_pad"><span>客户手机号：</span><input id="f_phone" role="textbox" class="domain-input easyui-textbox width140" data-options="readonly:true,editable:false,disabled:true"/></td>
						</tr>
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span>省（直辖市）：</span><input id="f_province" role="combobox" class="domain-input easyui-combobox width140" data-options="readonly:true,editable:false,disabled:true"/></td>
							<td class="td_pad"><span>市（区）：</span><input id="f_city" role="combobox" class="domain-input easyui-combobox width140" data-options="readonly:true,editable:false,disabled:true"/></td>
							<td class="td_pad"><span>详细地址：</span><input id="f_address" role="textbox" class="domain-input easyui-textbox width140" data-options="readonly:true,editable:false,disabled:true"/></td>
						</tr>
						<tr class="tr_ht" align="right">
						    <!--
							...
							<td class="td_pad"><span>服务进度情况：</span><input id="f_shippingStatusCode" role="combobox" class="domain-input easyui-combobox width140" /></td>
							 -->
							 <td class="td_pad"><span>订单类型：</span><input id="f_shippingId" role="combobox" class="domain-input easyui-combobox width140" data-options="readonly:true,editable:false,disabled:true"/></td>
							<td class="td_pad"><span>订单状态：</span><input id="f_orderStatusCode" role="combobox" class="domain-input easyui-combobox width140" data-options="readonly:true,editable:false,disabled:true"/></td>
						</tr>
						<tr class="tr_ht" align="right">
						...
						<tr class="tr_ht" align="right">
							<td colspan="3" class="td_pad"><span>订单备注：</span><input role="textbox" style="height:80px;width:580px;" id="f_postscript" class="domain-input easyui-textbox" data-options="multiline:true,readonly:true,editable:false,disabled:true"/></td>
						</tr>
						<tr class="tr_ht" align="right">
							<td colspan="3" class="td_pad"><span>审核回复：</span><input role="textbox" style="height:80px;width:580px;" id="f_howOos" class="domain-input easyui-textbox" data-options="multiline:true"/></td>
						</tr>
					</tbody>
				</table>
			</form>
			<div class="inline-center mgV40">
				<button id="mainObjSave" onclick="AuditRefundYes()" class="button button-primary button-rounded button-small">通过</button>
				<button id="mainObjSave" onclick="AuditRefundNo()" class="button button-primary button-rounded button-small">不通过</button>
	...
	<script type="text/javascript" src="/base/js/common/common_upload.js"
		title="bv"></script>
	<script type="text/javascript" src="/js/back/domain/order/refundorderinfo.js"
		title="v"></script>
</body>
</html>