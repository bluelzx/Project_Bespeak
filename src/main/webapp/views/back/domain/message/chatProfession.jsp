...
<body>
    ...
    <table>
		<tbody>
			<tr class="tr_ht">
				<td class="td_pad"><span>发送人编号：</span><input id="senderSerial" class="easyui-textbox width120" /></td>
				<td class="td_pad"><span>消息内容：</span><input id="content" class="easyui-textbox width120" /></td>
				<td class="td_pad"><span>发送时间：</span><input id="sendTime" data-options="editable:false" class="easyui-datebox width120" /></td>
...
<script type="text/javascript" src="/js/back/chat/chatProfession.js" title="v"></script>
</body>
</html>