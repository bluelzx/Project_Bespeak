...
<body>
	...
	<div class="fl_opt_div">
		...
		<button id="addForumMember" onclick="addForumMember();return false;" class="button button-primary button-rounded button-small">添加</button>
		...
		<button id="forumArticleLink" onclick="jumpToForumArticle();return false;" class="button button-royal button-rounded button-small">论坛帖子</button>
    ...
    <div id="forumMemberDetailWindiv" style="display:none;">
	     <div id='forumMemberDetailWin' class="easyui-window" title="添加论坛用户" style="width: 750px;height:350px" data-options="modal:true,closed:true,maximizable:false,collapsible:false,minimizable:false">
	         <div id="forumMemberDetailTip" style="margin-left: 28px;"></div>
	         <form id="forumMemberDetailForm"><br/>
	       		 <table id="forumMemberDetailTable" class="padL5">
					<tbody>
						...
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span>论坛名称：</span><input id="f_forum" class="easyui-combobox width140"/></td>
						</tr>
						<!-- <tr class="tr_ht" align="right">
			 ...
			 <div class="inline-center mgV40">
			     <button id="forumMemberDetailSave" onclick="submitForumMemberDetail()"  class="button button-primary button-rounded button-small" >保存</button>
			     <button id="forumMemberDetailBack" onclick="closeForumMemberDetailWin()"  class="button button-primary button-rounded button-small" >返回</button>
			 </div>
	     </div>
	</div>
    
<%@ include file="/views/common/common_back_js.htm"%>
<script type="text/javascript" src="/js/back/forumMember/forumMember.js" title="v"></script>
</body>
</html>