		...
		<form id="announcementForm">
			<table>
			        <tr class="tr_ht" align="right">
						<td >标&nbsp;题:</td>
						<td class="td_pad" colspan="5"><input id="f_title" class="domain-input easyui-textbox" style="width:720px" data-options="required:true" value="${article.title}" readonly="readonly"/></td>
					</tr>
					<tr class="tr_ht" align="right">
						<td >用&nbsp;户:</td>
...
<script type="text/javascript" src="/js/back/base/article/articleDetail.js" title="v"></script>
</body>
</html>