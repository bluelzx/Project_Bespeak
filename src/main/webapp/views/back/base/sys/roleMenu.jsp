...
<body>
   	...
   	<table id="mainQueryTable">
		<tbody>
			<tr class="tr_ht" align="right">
				<td class="td_pad"><span>角色名：</span><input role="textbox" id="sc_name" class="domain-input easyui-textbox width140" /></td>
	...
	<div id="opt_outer_div">
		<div class="fl_opt_div">
			...
			<button role="opt_1" onclick="addMainObj()" class="button button-primary button-rounded button-small">添加角色</button>
    ...
    <div id="mainObjWindiv" style="display:none;">
	     <div id='mainObjWin' class="easyui-window" title="用户角色信息" style="width: 280px;" data-options="modal:true,closed:true,maximizable:false,collapsible:false,minimizable:false">
			<div id="mainObjTip"></div>
	         <form id="mainObjForm"><br/>
	       		 <table id="mainObjTable" class="padL5">
					<tbody>
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span>角色名：</span><input role="textbox" id="f_name" class="domain-input easyui-textbox width140" data-options="required:true"/></td>
						</tr>
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span>上级角色：</span><input role="combobox" id="f_parentId" class="domain-input easyui-textbox width140" data-options="required:true"/></td>	
						</tr>
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span>描述：</span><input role="textbox" id="f_description" class="domain-input easyui-textbox width140" data-options="required:true"/></td>	
						</tr>
					</tbody>
				 </table>
			 </form>  
	...
	<script type="text/javascript" src="/js/back/base/sys/roleMenu.js" title="v"></script>
</body>
</html>