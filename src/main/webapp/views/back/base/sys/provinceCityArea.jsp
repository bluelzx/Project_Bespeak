...
<body>
   	...
   	<table id="mainQueryTable">
		<tbody>
			<tr class="tr_ht" align="right">
				<td class="td_pad"><span>市区名称：</span><input role="textbox" id="sc_areaNameLike" class="domain-input easyui-textbox width140" /></td>
				<td class="td_pad"><span>省(直辖市)：</span><input role="combobox" id="sc_parentId" class="domain-input easyui-combobox width140" /></td>
    ...
    <div id="mainObjWindiv" style="display:none;">
	     <div id='mainObjWin' class="easyui-window" title="数据字典" style="width: 260px;" data-options="modal:true,closed:true,maximizable:false,collapsible:false,minimizable:false">
			<div id="mainObjTip">请勿随意修改省市区数据</div>
	         <form id="mainObjForm"><br/>
	       		 <table id="mainObjTable" class="padL5">
					<tbody>
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span>城市名称：</span><input role="textbox" id="f_areaName" class="domain-input easyui-textbox width140" data-options="required:true"/></td>
						</tr>
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span>省(直辖市)：</span><input role="combobox" id="f_parentId" class="domain-input domain-input easyui-combobox width140"/></td>
						</tr>
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span>状态：</span><input role="combobox" id="f_mainStatus" class="domain-input easyui-combobox width140"
							data-options="valueField:'id',textField:'name',editable:false,multiple:false,required:true,panelHeight:'auto',data:[{'id':1,'name':'启用'},{'id':2,'name':'停用'}]"/>
							</td>
						</tr>
					</tbody>
				 </table>
	...
	<script type="text/javascript" src="/js/back/base/sys/provinceCityArea.js" title="v"></script>
</body>
</html>