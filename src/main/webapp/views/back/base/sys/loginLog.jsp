...
<body>
   	...
   	<table id="mainQueryTable">
		<tbody>
			<tr class="tr_ht" align="right">
				<td class="td_pad"><span>登录人姓名：</span><input role="textbox" id="sc_username" class="domain-input easyui-textbox width140" /></td>
				<td class="td_pad"><span>登录时间从：</span><input role="datebox" id="sc_loginTimeFrom" data-options="editable:false"class="domain-input easyui-datebox width140" /></td>
				<td class="td_pad"><span>至：</span><input role="datebox" id="sc_loginTimeTo" data-options="editable:false"class="domain-input easyui-datebox width140" /></td>
	...
	<script type="text/javascript" src="/js/back/base/sys/loginLog.js" title="v"></script>
</body>
</html>