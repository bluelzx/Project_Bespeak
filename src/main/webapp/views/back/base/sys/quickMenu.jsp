...
<body>
	...
	<table>
		<tbody>
			<tr class="tr_ht" align="right">
				...
				<td class="td_pad"><span>菜单：</span><input id="menu" class="easyui-combobox width120" /></td>
	...
	<div class="fl_opt_div">
		...
		<button id="addQuickMenu" onclick="addQuickMenu();return false;" class="button button-primary button-rounded button-small">添加</button>
    ...
    <div id="quickMenuDetailWindiv" style="display:none;">
	     <div id='quickMenuDetailWin' class="easyui-window" title="添加数据字典信息" style="width: 700px;height:350px" data-options="modal:true,closed:true,maximizable:false,collapsible:false,minimizable:false">
	         <div id="quickMenuDetailTip" style="margin-left: 28px;"></div>
	         <form id="quickMenuDetailForm"><br/>
					...
					<tbody>
						...
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span>菜单名称:</span><input id="f_menu" class="easyui-combobox width140"/></td>
			 ...
			 <div class="inline-center mgV40">
			     <button id="quickMenuDetailSave" onclick="submitQuickMenuDetail()"  class="button button-primary button-rounded button-small" >保存</button>
			     <button id="quickMenuDetailBack" onclick="closeQuickMenuDetailWin()"  class="button button-primary button-rounded button-small" >返回</button>
			 </div>
	     </div>
	</div>
...
<script type="text/javascript" src="/js/back/quickMenu/quickMenu.js" title="v"></script>
</body>
</html>