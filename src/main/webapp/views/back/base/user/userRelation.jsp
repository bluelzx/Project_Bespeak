...
<body>
	...
	<div class="fl_opt_div">
		...
		<button id="antiqueCityLink" onclick="jumpToAntiqueCity();return false;" class="button button-royal button-rounded button-small">商圈</button>
    ...
    <div id="userRelationDetailWindiv" style="display:none;">
	     <div id='userRelationDetailWin' class="easyui-window" title="添加商圈用户" style="width: 750px;height:350px" data-options="modal:true,closed:true,maximizable:false,collapsible:false,minimizable:false">
	         ...
	         <form id="userRelationDetailForm"><br/>
					...
					<tbody>
						...
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span>商圈名称：</span><input id="f_antiqueCity" class="easyui-combobox width140"/></td>
						</tr>
						<!-- <tr class="tr_ht" align="right">
