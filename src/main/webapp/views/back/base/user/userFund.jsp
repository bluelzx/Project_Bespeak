...
<body>
	...
	<!-- 表格  结束 -->
     ...
     <div id="userFundWindiv" style="display:none;">
	     <div id='userFundWin' class="easyui-window" title="用户资金详细信息" style="width: 300px;height:400px" data-options="modal:true,closed:true,maximizable:false,collapsible:false,minimizable:false">
	         <form id="userFundForm"><br/>
					...
					<tbody>
						...
						<tr class="tr_ht readOnlyTr" align="right" id="type">
							<td class="td_pad"><span class="colorGray">操作：</span><input id="f_type" data-options="readonly:true" class="easyui-combobox width140"/></td>
						</tr>
						<tr class="tr_ht readOnlyTr" align="right" id="tradeType">
							<td class="td_pad"><span class="colorGray">交易类型：</span><input id="f_tradeType" data-options="readonly:true" class="easyui-combobox width140"/></td>
						</tr>
						<tr class="tr_ht readOnlyTr" align="right" id="newMoney">
							<td class="td_pad"><span class="colorGray">金额：</span><input id="f_money" data-options="readonly:true" class="easyui-textbox width140"/></td>
						</tr>
					</tbody>
				 </table>
			 </form>  
