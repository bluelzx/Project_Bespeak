	...
	<table id="mainQueryTable">
		<tbody>
			<tr class="tr_ht" align="right">
				<td class="td_pad"><span>论坛名：</span><input role="textbox" id="sc_name" class="domain-input easyui-textbox width100" /></td>
				<td class="td_pad"><span>论坛类型：</span><input role="textbox" id="sc_typeDesc" class="domain-input easyui-textbox width100" /></td>
				<td class="td_pad"><span>上级论坛：</span><input role="combobox" id="sc_parentId" class="domain-input easyui-combobox width100" /></td>
				<td class="td_pad"><span>版主名：</span><input role="combobox" id="sc_moderatorId" class="domain-input easyui-combobox width100" /></td>
			...
			<!--
			<tr class="tr_ht" align="right">
				 <td class="td_pad"><span>是否热门：</span><input role="combobox" id="sc_isHot" class="domain-input easyui-combobox width100" /></td>
		...
		<div id='mainObjWin' class="easyui-window" title="论坛信息" style="width: 740px;" data-options="modal:true,closed:true,maximizable:false,collapsible:false,minimizable:false">
			...
			<form id="mainObjForm">
				...
				<table id="mainObjTable" class="padL5">
					<tbody>
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span><span style="color: red; font-weight: bolder;">*</span>论坛名：</span><input role="textbox" id="f_name" class="domain-input easyui-textbox width140" data-options="required:true" /></td>
							<td class="td_pad"><span><span style="color: red; font-weight: bolder;">*</span>上级论坛：</span><input role="combobox" id="f_parentId" class="domain-input easyui-combobox width140" data-options="required:true" /></td>
							<td class="td_pad"><span><span style="color: red; font-weight: bolder;">*</span>类型：</span><input role="textbox" id="f_typeDesc" class="domain-input easyui-textbox width140" data-options="required:true" /></td>
						</tr>
						<tr class="tr_ht" align="right">
						<td class="td_pad"><span><span style="color: red; font-weight: bolder;">*</span>版主：</span><input role="combobox" id="f_moderatorId" class="domain-input easyui-combobox width140" data-options="required:true" /></td>
							<td class="td_pad"><span>副版主：</span><input role="combobox" id="f_subModeratorId" class="domain-input easyui-combobox width140"/></td>
							<td class="td_pad"><span>人数：</span><input role="textbox" id="f_memberCount" class="domain-input easyui-textbox width140"/></td>
						</tr>
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span>帖子数：</span><input role="textbox" id="f_articleMemberCount" class="domain-input easyui-textbox width140"/></td>
							<td class="td_pad"><span>首页:http://</span><input role="textbox" id="f_mainPath" class="domain-input easyui-textbox width140" /></td>
							<!--  <td class="td_pad"><span>论坛链接地址：</span><input role="textbox" id="f_linkPath" class="domain-input easyui-textbox width140"/></td> -->
						</tr>
						<tr class="tr_ht" align="right">
							<td colspan="3" class="td_pad"><span><span style="color:red;font-weight:bolder;">*</span>版规：</span><input role="textbox" style="width:600px;" maxlength:"50" id="f_ruleDesc" class="domain-input easyui-textbox" data-options="required:true"/></td>
						</tr>
					</tbody>
				</table>
			</form>
			...
			<div style="display: inline-block; float: left;">
				<img id="f_logo" class="picurl" src="${pic.picPath}" style="height: 60px; max-width: 100px; overflow: hidden; padding: 5px;" /> <input type="hidden" name="filePaths" id="filePaths" value="${pic.picPath}" /> <input
