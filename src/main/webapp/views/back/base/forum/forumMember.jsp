...
<body style="min-width:1000px;">
   	...
   	<table id="mainQueryTable">
		<tbody>
			<tr class="tr_ht" align="right">
				<td class="td_pad"><span>用户：</span><input role="combobox" id="sc_userId" class="domain-input easyui-combobox width100" /></td>
				<td class="td_pad"><span>论坛：</span><input role="combobox" id="sc_forumId" class="domain-input easyui-combobox width100" /></td>
    ...
    <div id="mainObjWindiv" style="display:none;">
	     <div id='mainObjWin' class="easyui-window" title=" 社区成员信息" style="width: 740px;" data-options="modal:true,closed:true,maximizable:false,collapsible:false,minimizable:false">
			<div id="mainObjTip"></div>
	         <form id="mainObjForm"><br/>
	       		 <table id="mainObjTable" class="padL5">
					<tbody>
						<tr class="tr_ht" align="right">
						<td class="td_pad"><span><span style="color:red;font-weight:bolder;">*</span>用户 ：</span><input role="combobox" id="f_userId" class="domain-input easyui-combobox width140" data-options="required:true"/></td>
							<td class="td_pad"><span><span style="color:red;font-weight:bolder;">*</span>论坛：</span><input role="combobox" id="f_forumId" class="domain-input easyui-combobox width140" data-options="required:true"/></td>
						<!-- 	<td class="td_pad"><span>用户标识：</span><input role="textbox" id="f_userSerial" class="domain-input easyui-combobox width140"/></td>  -->
						</tr>
						<!-- 
						<tr class="tr_ht" align="right">
						<td class="td_pad"><span><span style="color:red;font-weight:bolder;">*</span>用户名：</span><input role="combobox" id="f_username" class="domain-input easyui-combobox width140"/></td>
							<td class="td_pad"><span><span style="color:red;font-weight:bolder;">*</span>论坛名：</span><input role="combobox" id="f_forumName" class="domain-input easyui-combobox width140"/></td>
						</tr>
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span>重置密码：</span><input id="passwordReset" class="easyui-textbox width140"/></td>
						</tr>
						 -->
					</tbody>
				 </table>
			 ...
			 <div style="display:inline-block;float:left;">
				 <img id="forumLogo" class="picurl"  src="${pic.picPath}" style="height:60px;max-width:100px;overflow:hidden;padding:5px;"/>
	...
	<script type="text/javascript" src="/js/back/base/forum/forumMember.js" title="v"></script>
</body>
</html>