...
<body>
    ...
    <div id="mainObjWindiv" style="display:none;">
	     <div id='mainObjWin' class="easyui-window" title="专场聊天" style="width: 680px;" data-options="modal:true,closed:true,maximizable:false,collapsible:false,minimizable:false">
	         ...
	         <form id="mainObjForm"><br/>
					...
					<tbody>
						...
						<tr class="tr_ht" align="right">
							...
							<td class="td_pad"><span>发送类型：</span><input role="combobox" id="f_msgGroup" class="domain-input easyui-combobox width140" /></td>
	...
	<script type="text/javascript" src="/js/back/base/message/chatProfession.js" title="v"></script>
</body>
</html>