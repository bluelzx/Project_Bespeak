...
<body>
   	...
   	<table id="mainQueryTable">
		<tbody>
			<tr class="tr_ht" align="right">
				...
				<td class="td_pad"><span>消息类型：</span><input role="combobox" id="sc_typeCode" class="domain-input easyui-combobox width140" /></td>
			...
			<tr class="tr_ht" align="right">
				...
				<td class="td_pad"><span>发送日期：</span><input role="combobox" id="sc_sendTime" class="domain-input easyui-datebox width140" data-options="editable:false"/></td>
				<td class="td_pad"><span>消息内容：</span><input role="textbox" id="sc_contentLike" class="domain-input easyui-textbox width140" /></td>
    ...
    <div id="mainObjWindiv" style="display:none;">
	     <div id='mainObjWin' class="easyui-window" title="消息" style="width: 680px;" data-options="modal:true,closed:true,maximizable:false,collapsible:false,minimizable:false">
	         ...
	         <form id="mainObjForm"><br/>
					...
					<tbody>
						...
						<tr class="tr_ht" align="right">
							...
							<td class="td_pad"><span>接收用户：</span><input role="combobox" id="f_receiverId" class="domain-input easyui-combobox width140" /></td>
							<td class="td_pad"><span>消息类型：</span><input role="combobox" id="f_typeCode" class="domain-input easyui-combobox width140" /></td>
						</tr>
						<tr class="tr_ht" align="right">
							<td class="td_pad"><span>阅读状态：</span><input role="combobox" id="f_readStatus" class="domain-input easyui-combobox width140" 
							data-options="valueField:'id',textField:'name',editable:false,multiple:false,required:false,panelHeight:'auto',data:[{'id':1,'name':'未读'},{'id':2,'name':'已读'}]"/>
							</td>
							<td class="td_pad"><span>发送日期：</span><input role="combobox" id="f_sendTime" class="domain-input easyui-datebox width140" data-options="editable:false"/></td>
						</tr>
						<tr class="tr_ht" align="right">
							<td colspan="3" class="td_pad"><span>消息内容：</span><input role="textbox" style="height:60px;width:580px;" id="f_content" class="domain-input easyui-textbox" data-options="multiline:true"/></td>
						</tr>
	...
	<script type="text/javascript" src="/js/back/base/message/message.js" title="v"></script>
</body>
</html>